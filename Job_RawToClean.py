...
from pyspark.sql.functions import to_utc_timestamp, year, month
...
print(f"procesando archivo nuevo desde: {input_path}")
...
sink.setCatalogInfo(catalogDatabase="datalake-catalog-taxis", catalogTableName="taxi_cleaned")
